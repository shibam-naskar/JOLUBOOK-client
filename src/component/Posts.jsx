...
const Posts = (props) => {
  ...
  return (
    <div>
      <section className="posts  border_radius border-secondary mt-3  overflow-hidden p-0 white  position-relative">
        ...
        {props.post.photo && <div className="">
          ...
          {props.post.photo.toString().endsWith(".mp4") ? (
            <div style={{}} className="video">
              <Waypoint
                onEnter={handleVideoPress}
                onLeave={handleVideoPress}
              >
                <video onClick={handleVideoPress} ref={videoRef} className="w-100" style={{ padding: 20, borderRadius: "35px", marginRight: 60 }} controls >
                  <source src={props.post.photo} type="video/mp4" />
                </video>
              </Waypoint>
            </div>
          ) : (
            <img src={props.post.photo} alt="" className="w-100" style={{ padding: 20, borderRadius: "35px" }} />
          )}
