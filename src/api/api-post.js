...
const getFeed = async (params, credentials, signal) => {
  try {
    ...
    let response = await fetch('https://jolubook-backend-production.up.railway.app/api/post/feed/' + params.userId + "?page=" + params.page, requestOptions)
...
const getFeedUser = async (params, credentials, signal) => {
  try {
    ...
    let response = await fetch('https://jolubook-backend-production.up.railway.app/api/post/feedUser/' + params.userId, requestOptions)
...
const findPeoplee = async (params, credentials, signal) => {
  try {
    let response = await fetch('https://jolubook-backend-production.up.railway.app/api/users/findpeople/' + params.userId, {
      method: 'GET',
      headers: {
        'Accept': 'application/json',
        'Content-Type': 'application/json',
...
const remove = async (params, credentials) => {
  try {
    let response = await fetch('https://jolubook-backend-production.up.railway.app/api/post/' + params.postId, {
      method: 'DELETE',
      headers: {
        'Accept': 'application/json',
        'Content-Type': 'application/json',
...
const unfollow = async (params, credentials, unfollowId) => {
  ...
  try {
    let response = await fetch('https://jolubook-backend-production.up.railway.app/api/users/unfollow/', {
      method: 'PUT',
      headers: {
        'Accept': 'application/json',
        'Content-Type': 'application/json',
...
const Like = async (params, credentials, postId) => {
  ...
  try {
    ...
    let response = await fetch('https://jolubook-backend-production.up.railway.app/api/post/like',
      {
        method: 'PUT',
        headers: {
          'Accept': 'application/json',
...
const unlike = async (params, credentials, postId) => {
  ...
  try {
    ...
    let response = await fetch('https://jolubook-backend-production.up.railway.app/api/post/unlike',
      {
        method: 'PUT',
        headers: {
          'Accept': 'application/json',
...
const comment = async (params, credentials, postId, comment) => {
  try {
    let response = await fetch('https://jolubook-backend-production.up.railway.app/api/post/comment/', {
      method: 'PUT',
      headers: {
        'Accept': 'application/json',
        'Content-Type': 'application/json',
...
const read = async (params, credentials, signal) => {
  try {
    let response = await fetch('https://jolubook-backend-production.up.railway.app/api/users/' + params.userId, {
      method: 'GET',
      headers: {
        'Accept': 'application/json',
        'Content-Type': 'application/json',
...
const update = async (params, credentials, Values) => {
  let v = { name: "FFF" }
  try {
    let response = await fetch('https://jolubook-backend-production.up.railway.app/api/users/update/' + params.userId, {
      method: 'PUT',
      headers: {
        'Content-Type': 'application/json',
        'Authorization': credentials.t
...
const getChat = async (params, credentials, se) => {
  try {
    let response = await fetch(`https://jolubook-backend-production.up.railway.app/api/chat/`, {
      method: 'POST',
      headers: {
        'Accept': 'application/json',
        'Content-Type': 'application/json',
